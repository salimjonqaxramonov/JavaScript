...
if( data === "nexia" ||  data === "Damas" || data === "kobalt" || data === "spark" || data === "matiz" || data === "onix" || data === "treker" || data === "tiko" || data === "monza") {
    console.log("Bu mashina JM avto salonida ishlab chiqarilgan");
}
else if( data === "M5" || data === "E30" || data === "E46" || data === "X5" || data === "507") {
    console.log("Bu moshina BMW avtosalonida ishlab chiqarilgan");
}
else if( data === "300 SL" || data === "SLS AMG" || data === "190 SL" || data === "500 E"){
    console.log("Bu avtomabil Mercedes Benz avtosalonida ishlab chiqarilga ");
}
else if ( data === "Tesla modeli X" || data === "cybertrack" || data === "Tesla modeli 3" || data === "Tesla modeli S") {
    console.log("Bu avtomabil Tesla avosalonida ishlab chiqarilga");
}
else if ( data === "OSH" || data === "Mastava" || data === "Shorva" || data === "Lagman" || data === "chuchvara" || data === "somsa") {
    console.log("Bu ovqat O'zbek milliy taomi");   
}
else if ( data === "Lavash" || data === "danar" || data === "pizza" || data === "Rolton" || data === "hoy-dog" || data === "chizburger" || data === "gamburger"){
    console.log("Bu taomlar Fast Foodga kiradi");   
}
else if ( data === "bishteks" || data === "Sushi" || data === "gizitzot" | data === "spagetti"){
